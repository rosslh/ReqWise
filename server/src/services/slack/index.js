    ...
    fastify.post(
        ...
        async (request, reply) => {
            if (request.body.text === "help") {
                ...
                const modal = fastify.slackPayloads.newFeatureModal({ projects, slackAccessToken, body: request.body });
                ...
                const modal = fastify.slackPayloads.newRequirementModal({ slackAccessToken, reqgroups, body: request.body });
