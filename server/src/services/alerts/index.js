    ...
    fastify.get(
        ...
        async function (request, reply) {
            ...
            return await fastify.knex
                ...
                .limit(limit)
                .offset(offset)
                .select("alert.*", "account_alert.*", "team.name as teamName", "project.name as projectName", "project.team_id as team_id", "account.name as authorName", "account.imageName as authorImageName", "alert.id as id", "requirement.id as requirement_id")
